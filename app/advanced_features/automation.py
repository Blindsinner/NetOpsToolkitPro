...
# REFACTORED: Changed from QDialog to BaseToolWidget.

import json
import yaml
from PySide6.QtWidgets import (
    QWidget, QVBoxLayout, QHBoxLayout, QSplitter, QGroupBox, QListWidget, # QDialog changed to QWidget
...
class AutomationWidget(BaseToolWidget): # REFACTORED: Class name and inheritance
    def __init__(self, settings, task_manager): # REFACTORED: Consistent constructor
        ...
        # REFACTORED: Window setup is removed.
    ...
    def shutdown(self):
        """No active resources to shut down, but method is here for consistency."""
        pass
